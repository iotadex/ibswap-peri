...
library OracleLibrary {
    /// @notice Calculates time-weighted means of tick and liquidity for a given IotabeeSwap pool
    ...
    /// @param pool Address of IotabeeSwap pool that we want to observe
    ...
    /// @param pool Address of IotabeeSwap pool
